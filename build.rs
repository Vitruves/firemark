fn main() {
    ...
    println!("cargo:warning=    so AI removal must reconstruct real detail and becomes visibly lossy");
    ...
    println!("cargo:warning=  • PDF-to-image conversion: -o output.png/jpeg now rasterizes via pdftoppm");
